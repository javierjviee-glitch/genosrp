...
if not IsValid(kaer3) then
local rand = math.random(1,5)
if rand == 1 then
kaer3 = ents.Create("npc_vj_g_doll")
kaer3:SetPos(self:GetPos())
kaer3:SetAngles(self:GetAngles())
kaer3:Spawn()
kaer3:Activate()
kaer3:SetOwner(self)
self:DeleteOnRemove(kaer3)

elseif rand == 2 then
kaer3 = ents.Create("npc_vj_g_baby")
kaer3:SetPos(self:GetPos())
kaer3:SetAngles(self:GetAngles())
kaer3:Spawn()
kaer3:Activate()
...
elseif rand == 3 then
kaer3 = ents.Create("npc_vj_g_headmonster")
kaer3:SetPos(self:GetPos())
kaer3:SetAngles(self:GetAngles())
kaer3:Spawn()
kaer3:Activate()
...
elseif rand == 4 then
kaer3 = ents.Create("npc_vj_g_floaters")
kaer3:SetPos(self:GetPos())
kaer3:SetAngles(self:GetAngles())
kaer3:Spawn()
kaer3:Activate()
