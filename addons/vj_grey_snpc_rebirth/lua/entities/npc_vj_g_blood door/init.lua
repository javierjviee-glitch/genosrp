...
if not IsValid(kaer) then
local rand = math.random(1,5)
if rand == 1 then
kaer = ents.Create("npc_vj_g_doll")
kaer:SetPos(self:GetPos())
kaer:SetAngles(self:GetAngles())
kaer:Spawn()
kaer:Activate()
kaer:SetOwner(self)
self:DeleteOnRemove(kaer)
...
elseif rand == 3 then
kaer = ents.Create("npc_vj_g_headmonster")
kaer:SetPos(self:GetPos())
kaer:SetAngles(self:GetAngles())
kaer:Spawn()
kaer:Activate()
...
elseif rand == 4 then
kaer = ents.Create("npc_vj_g_floaters")
kaer:SetPos(self:GetPos())
kaer:SetAngles(self:GetAngles())
kaer:Spawn()
kaer:Activate()
...
elseif rand == 5 then
kaer = ents.Create("npc_vj_g_creepy")
kaer:SetPos(self:GetPos())
kaer:SetAngles(self:GetAngles())
kaer:Spawn()
kaer:Activate()
