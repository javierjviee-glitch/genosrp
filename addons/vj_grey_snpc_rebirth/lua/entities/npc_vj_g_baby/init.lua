...
ENT.SoundTbl_Alert = {"baby/babyalert.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"baby/attack1.wav","baby/attack2.wav"}
ENT.SoundTbl_MeleeAttackMiss = {"baby/miss1.wav","baby/miss2.wav"}
ENT.SoundTbl_Pain = {"baby/baby_pain1.wav"}
ENT.SoundTbl_Death = {"baby/babydie.wav","baby/babydie2.wav"}
--[[
	*** Copyright (c) 2012-2017 by DrVrej, All rights reserved. ***
	No parts of this code or any of its contents may be reproduced, copied, modified or adapted,
	without the prior written consent of the author, unless otherwise indicated for stand-alone materials.
