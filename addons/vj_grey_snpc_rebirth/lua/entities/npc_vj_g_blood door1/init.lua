...
if not IsValid(kaer1) then
local rand = math.random(1,5)
if rand == 1 then
kaer1 = ents.Create("npc_vj_g_doll")
kaer1:SetPos(self:GetPos())
kaer1:SetAngles(self:GetAngles())
kaer1:Spawn()
kaer1:Activate()
kaer1:SetOwner(self)
self:DeleteOnRemove(kaer1)

elseif rand == 2 then
kaer1 = ents.Create("npc_vj_g_dog")
kaer1:SetPos(self:GetPos())
kaer1:SetAngles(self:GetAngles())
kaer1:Spawn()
kaer1:Activate()
...
elseif rand == 3 then
kaer1 = ents.Create("npc_vj_g_headmonster")
kaer1:SetPos(self:GetPos())
kaer1:SetAngles(self:GetAngles())
kaer1:Spawn()
kaer1:Activate()
...
elseif rand == 4 then
kaer1 = ents.Create("npc_vj_g_floaters")
kaer1:SetPos(self:GetPos())
kaer1:SetAngles(self:GetAngles())
kaer1:Spawn()
kaer1:Activate()
...
elseif rand == 5 then
kaer1 = ents.Create("npc_vj_g_creepy")
kaer1:SetPos(self:GetPos())
kaer1:SetAngles(self:GetAngles())
kaer1:Spawn()
kaer1:Activate()
