...
function ENT:CustomOnThink_AIEnabled()
	...
	self.Death = true
	local d = self:GetEnemy()
timer.Simple(13,function() if IsValid(self) and IsValid(d) then d:TakeDamage(99999999999,self,self) end end)
timer.Simple(13.2,function() if IsValid(self) then self:TakeDamage(99999999999,self,self)
ParticleEffect("curse_attack1",self:GetPos() + self:GetUp()*40,Angle(0,0,0),nil)
 end end)
end
end
end
