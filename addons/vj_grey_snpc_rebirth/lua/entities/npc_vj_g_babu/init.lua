...
ENT.SoundTbl_FootStep = {"babu/foot1.wav","babu/foot2.wav","babu/foot3.wav","babu/foot4.wav"}
ENT.SoundTbl_Alert = {"babu/loop1.wav","babu/loop2.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"babu/attack1.wav","babu/attack2.wav"}
ENT.SoundTbl_MeleeAttackMiss = {"babu/miss1.wav","babu/miss2.wav"}
ENT.SoundTbl_Pain = {"babu/pain1.wav","babu/pain2.wav"}
